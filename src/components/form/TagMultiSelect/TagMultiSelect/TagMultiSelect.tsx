...
const TagMultiSelect: FC<TagMultiSelectProps> = ({
  ...
  const { tags: allTags, isGettingTags: isGettingAllTags } = useGetTags();
  ...
  return (
    <div className={classes.root}>
      ...
      <div className="p-search-and-filter" ref={clickContainerRef}>
        ...
        {showDropdown && isGettingAllTags && <LoadingState />}
        {showDropdown && !isGettingAllTags && (
