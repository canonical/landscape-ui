...
import InstancesTableHeader from "@/pages/dashboard/instances/[single]/tabs/instances/InstancesPanelHeader";
...
const InstancesTable: FC<InstancesTableProps> = ({ instance }) => {
