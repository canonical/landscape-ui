...
export const mirrors = [
  ...
  {
    name: "mirrors/ubuntu-pro-mirror",
    mirrorId: "ubuntu-pro-mirror",
    displayName: "Ubuntu Pro mirror",
    archiveRoot: "https://bearer:s3cr3t-token@esm.ubuntu.com/infra/ubuntu/",
