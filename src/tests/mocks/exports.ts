...
export const processingExportJob: ExportJob = {
  ...
  row_count: 120,
  type: "instance",
  attribute_labels: ["Instance name", "Hostname", "Status"],
...
export const completedExportJob: ExportJob = {
  ...
  row_count: 42,
  type: "instance",
  attribute_labels: ["Instance name", "Access group"],
...
export const processingActivitiesExportJob: ExportJob = {
  ...
  row_count: 50,
  type: "activity",
  attribute_labels: ["ID", "Type", "Summary", "Status"],
  created_at: "2026-06-03T12:10:00.000Z",
  status: "processing",
  progress: 30,
  download_ready: false,
...
export const completedActivitiesExportJob: ExportJob = {
  ...
  row_count: 20,
  type: "activity",
  attribute_labels: ["ID", "Type", "Creator"],
  created_at: "2026-06-03T12:08:00.000Z",
  status: "completed",
  progress: 100,
  download_ready: true,
