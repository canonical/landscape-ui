 ...
 */
export const MANAGE_INSTANCES_DOCUMENTATION_URL =
  `${EXTERNAL_PATHS.documentation}/how-to-guides/landscape-installation-and-set-up/configure-landscape-client/`;
