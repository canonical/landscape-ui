  ...
  const removeFromLandscape = async () => {
    try {
      ...
      notify.success({
        ...
        message: `${pluralize(instances.length, `${title} has been removed from Landscape. To manage it again, you will need to re-register it in Landscape.`, { pluralForm: `${title} have been removed from Landscape. To manage them again, you will need to re-register them in Landscape.` })}`,
      });
