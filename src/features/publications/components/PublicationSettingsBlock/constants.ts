export const PUBLICATION_SETTINGS_HELP_TEXT = {
  ...
  limitAutomaticInstallation: `This tells apt that packages in this repository should not be installed or upgraded automatically. Users must explicitly target this repository or specific package versions to install them.`,
