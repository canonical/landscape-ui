  ...
  it.each([
    ...
    [
      ProfileTypes.script,
      {
        ...baseProfile,
        script_id: 3,
        computers: { num_associated_computers: 10000 },
    ...
    [
      ProfileTypes.removal,
      {
        ...
        computers: { num_associated_computers: 5 },
      },
      "5",
    ],
    [
      ProfileTypes.upgrade,
      {
        ...baseProfile,
        upgrade_type: "all",
        computers: { num_associated_computers: 10 },
      },
      "10",
    ],
    [
    ...
    async (type, profile, expectedCount) => {
      ...
      expect(
        screen.getByRole("link", { name: `${expectedCount} instances` }),
      ).toHaveAttribute(
        "href",
