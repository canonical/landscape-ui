...
import { hasLastRunData, isProfileArchived, isRebootProfile, isScriptProfile, isSecurityProfile, isUpgradeProfile } from "../../../../helpers";
        ...
        <InfoGrid dense>       
          ...
          {hasLastRunData(profile) &&
            <InfoGrid.Item
              ...
              value={
                lastRun ? (
                  moment(lastRun).utc().format(DISPLAY_DATE_TIME_FORMAT)
                ) : null
              }
            />
          }
          ...
          {!isProfileArchived(profile) &&
            <InfoGrid.Item
              ...
              value={
                nextRun ? (
                  moment(nextRun).utc().format(DISPLAY_DATE_TIME_FORMAT)
                ) : null
              }
            />
          }
