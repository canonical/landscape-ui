...
import { hasLastRunData, isPostEnrollmentScriptProfile, isProfileArchived, isRebootProfile, isScriptProfile, isSecurityProfile, isUpgradeProfile } from "../../../../helpers";
...
const ViewProfileScheduleBlock: FC<ViewProfileScheduleBlockProps> = ({
  ...
  const hasNextRun = !isProfileArchived(profile) && !isPostEnrollmentScriptProfile(profile);
