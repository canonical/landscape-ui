...
const SecurityProfilesContainer: FC<SecurityProfilesContainerProps> = ({
  ...
  if (
    ...
    isOverLimitSecurityProfilesLoading ||
    isGettingActivities ||
    ...
    <>
      ...
      {overLimitSecurityProfiles.length === 1 && (
        ...
        >
          ...
          more than <strong>5,000 instances</strong>. Only the first 5,000 will
          be covered. Edit the profile or duplicate it to cover the rest.{" "}
          <Button
            type="button"
            appearance="link"
            onClick={() => {
