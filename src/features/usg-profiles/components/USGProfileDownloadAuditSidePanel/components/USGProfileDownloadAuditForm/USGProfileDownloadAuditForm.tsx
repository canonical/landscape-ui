...
import classes from "./USGProfileDownloadAuditForm.module.scss";

interface USGProfileDownloadAuditFormProps {
  readonly usgProfile: USGProfile;
}

interface USGProfileDownloadAuditFormValues {
...
const USGProfileDownloadAuditForm: FC<USGProfileDownloadAuditFormProps> = ({
  usgProfile,
}) => {
...
export default USGProfileDownloadAuditForm;
