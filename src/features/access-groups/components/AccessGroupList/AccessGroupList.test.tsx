...
describe("AccessGroupList", () => {
  ...
  it("opens confirmation modal when delete button is clicked", async () => {
    const [, groupToDelete] = accessGroups;
  ...
  it("renders access group titles as clickable links", async () => {
    ...
    await user.click(screen.getByRole("button", { name: accessGroup.title }));
