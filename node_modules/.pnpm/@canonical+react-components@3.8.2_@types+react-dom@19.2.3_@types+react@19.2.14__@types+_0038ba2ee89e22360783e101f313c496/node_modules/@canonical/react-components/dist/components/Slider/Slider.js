...
const Slider = _ref => {
  ...
  if ((_navigator = navigator) !== null && _navigator !== void 0 && (_navigator = _navigator.userAgent) !== null && _navigator !== void 0 && _navigator.includes("AppleWebKit")) {
    ...
    const val = (_inputProps$value = inputProps.value) !== null && _inputProps$value !== void 0 ? _inputProps$value : inputProps.defaultValue;
    const filledPercentage = "".concat((Number(val) - min) / (max - min) * 100, "%");
    style = {
