...
var _excluded = ["items", "selectedItems", "disabledItems", "header", "updateItems", "onSelectItem", "onDeselectItem", "isOpen", "footer", "dropdownClassName", "footerClassName", "emptyState", "emptyMessage", "sortFn", "groupFn", "hasSelectedItemsFirst"];
...
export var MultiSelectDropdown = _ref2 => {
  ...
  return /*#__PURE__*/React.createElement(FadeInDown, {
    ...
    className: classNames("multi-select__footer", footerClassName)
  }, footer) : null));
};
...
MultiSelectDropdown.propTypes = {
  ...
  footer: _pt.node,
  footerClassName: _pt.string,
  dropdownClassName: _pt.string,
  emptyState: _pt.node,
