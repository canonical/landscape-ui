...
const _excluded = ["items", "selectedItems", "disabledItems", "header", "updateItems", "onSelectItem", "onDeselectItem", "isOpen", "footer", "dropdownClassName", "footerClassName", "emptyState", "emptyMessage", "sortFn", "groupFn", "hasSelectedItemsFirst"];
...
const MultiSelectDropdown = _ref2 => {
  ...
  return /*#__PURE__*/_react.default.createElement(_FadeInDown.FadeInDown, {
    ...
    className: (0, _classnames.default)("multi-select__dropdown", dropdownClassName),
    role: "listbox"
    ...
    className: (0, _classnames.default)("multi-select__footer", footerClassName)
  }, footer) : null));
};
...
const MultiSelect = _ref4 => {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_index.ContextualMenu, {
    ...
    toggle: variant === "search" ? /*#__PURE__*/_react.default.createElement(_index.SearchBox, {
      ...
      className: (0, _classnames.default)("multi-select__input", inputClassName)
